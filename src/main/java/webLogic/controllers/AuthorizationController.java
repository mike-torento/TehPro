...
//            if (respUser != null) {
//                return new ResponseUser(respUser, respUser.hashCode(), ActionConstant.STATUS_SUCCESS);
//            } else {
//                return new ResponseUser(reqUser, ActionConstant.STATUS_ERROR, "Пользователь не найден.");
//            }
